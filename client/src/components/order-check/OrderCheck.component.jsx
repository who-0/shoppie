    ...
    <Check>
      {
       ...
       <div className='comment'>
          <textarea  placeholder="comments" name='comment' value={defaultState.comment} onChange={changeHandler} />
        ...
        <div className='status'>
          ...
          {
            status === 'cancel' ? (<option value="success">success</option>):(<option value="cancel">cancel</option>)
          }
